    ...
    namespace Components {
        ...
        public:
            ...
            InputText(const char* label, char* value, size_t size, ImGuiInputTextFlags flags = 0)
                : m_Label(label)
                , m_CharArrayValue(value)
                , m_CharArraySize(size)
                , m_Flags(flags)
                , m_Type(Type::CharArray) { }
            ...
            void Render() override {
                ...
                case Type::Int: {
                    ...
                    enterPressed = ImGui::InputText(m_Label,
                                                    buffer,
                                                    sizeof(buffer),
                ...
                case Type::CharArray: {
                    enterPressed
                        = ImGui::InputText(m_Label, m_CharArrayValue, m_CharArraySize, m_Flags);
                    break;
                }
                }
                ...
                if (enterPressed && (m_Flags & ImGuiInputTextFlags_EnterReturnsTrue)
        ...
        private:
            enum class Type { String, Int, CharArray };
