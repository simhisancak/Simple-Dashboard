...
View::View(Application* app, Renderer* renderer) : m_App(app), m_Renderer(renderer) {}
...
void View::RenderTitleBar(const char* title, bool showExitButton) {
    ...
    if (showExitButton) {
        ...
        ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(0.6f, 0.0f, 0.0f, 0.0f));  // Transparent red
        ...
        ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(0.2f, 0.2f, 0.2f, 0.0f));  // Transparent gray
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered,
        ...
        // Inject button
        float injectButtonX = minimizeButtonX - buttonSize - 4.0f;  // 4px spacing between buttons
        ImGui::SetCursorPos(ImVec2(injectButtonX, buttonY));

        // Button styling for inject button
        ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(0.0f, 0.2f, 0.0f, 0.0f));  // Transparent gray
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered,
...
void View::RenderInjectModal() {
    ...
    if (ImGui::BeginPopupModal("Inject Process",
        ...
        ImGui::PushStyleVar(ImGuiStyleVar_ItemSpacing, ImVec2(0, ThemeConfig::SeparatorPadding));
        ImGui::Separator();
        ImGui::PopStyleVar();
